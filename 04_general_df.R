...
df_receiver_sex <- tibble(
  ...
  freq = c(receiver_sex_freq, primary_giver_sex_freq),
  type = c(rep("Sex of Care Receiver Respondent", 2), rep("Sex of primary Caregiver, reported by Care Receiver Respondents", 2))
)
